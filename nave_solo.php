...
<main class="container background-color1">
    ...
    <div class="row">
        <div class="d-grid d-md-flex justify-content-md-end">
            <a class="btn boton btn-secondary rounded rounded-5 border border-light border-1 btn-sm mt-2" type="button" href="naves.php?categoria=naves" role="button">ATRÁS</a>
        </div>
    </div>
</main>

...
if ($termino_busqueda) {
    ...
    $productos = buscar_equipo($conn, $termino_busqueda);
}
...
<main class="container vh-100 background-color1">
    ...
    <?php } elseif ($termino_busqueda) { ?>
        <p class="text-center text-warning fs-3">No se encontraron items para el término de búsqueda: <?= $termino_busqueda ?> </p>
    <?php } else { ?>
